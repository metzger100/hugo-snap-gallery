...
- `caption`: Example `{{< snap-gallery src="img/folder2/, image2.png" caption="map[img/folder2/image1.jpg:{'Image 1'}, image2.png:{'Image 2'}]" >}}`  Add an optional caption for selected imagesn which gets displayed in the lightbox below the image if available. Default: `map[]`.
